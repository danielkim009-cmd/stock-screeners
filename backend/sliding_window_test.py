...
Config: PCT_TRAIL 25%, max 9 positions, RS_20 ranking, Monthly rebalance.
...
# ── Print summary table ───────────────────────────────────────────────────────
print("\n" + "="*120)
print("SLIDING 10-YEAR WINDOW RESULTS — S&P 500 | PCT_TRAIL 25% | 9 positions | RS_20 | Monthly rebalance")
print("="*120)
