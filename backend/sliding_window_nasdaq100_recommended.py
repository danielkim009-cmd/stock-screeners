...
WINDOW_YEARS = 10
# First trading day of 2006 (markets closed Jan 1–2)
WINDOW_START_MMDD = "01-03"
...
for start_year in START_YEARS:
    t_start = pd.Timestamp(f"{start_year}-{WINDOW_START_MMDD}")
    t_end   = pd.Timestamp(f"{start_year + WINDOW_YEARS}-{WINDOW_START_MMDD}")
